...
public class PrefillArrayMapList<T> implements List<T>, Collection<T>, RandomAccess {
    ...
    public PrefillArrayMapList(Predicate<T> nullCheck, T fillValue) {
    ...
    public PrefillArrayMapList(T fillValue) {
        this((T t) -> Objects.equals(t, fillValue), fillValue);
    }

    public PrefillArrayMapList() {
    ...
    private static class MapHelper<V> implements Map<Integer, V> {
        ...
        private PrefillArrayMapList<V> me;

        public MapHelper(PrefillArrayMapList<V> list) {
            me = list;
        }

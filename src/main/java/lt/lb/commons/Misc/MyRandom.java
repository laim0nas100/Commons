...
public class MyRandom extends java.util.Random {
    ...
    /**
     * Get a random number in the range [min, max) or [min, max] depending on
     * rounding.
     *
     * @param min Low bound
     ...
     * <p/>
     * lambda is 1.0 divided by the desired mean. It should be nonzero. Returned
     * values range from 0 to positive infinity if lambda is positive, and from
     * negative infinity to 0 if lambda is negative.
     *
     ...
     * <p/>
     * The probability distribution function is: pdf(x) = (x ** (alpha - 1) *
     * math.exp(-x / beta)) / (math.gamma(alpha) * beta ** alpha)
     *
     * @param alpha Alpha
     * @param beta Beta

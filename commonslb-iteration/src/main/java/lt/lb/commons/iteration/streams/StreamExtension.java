...
public interface StreamExtension<X, M extends DecoratableStream<X, M>> {
    ...
    public static interface StreamExtensionsAll<X, M extends DecoratableStream<X, M>> extends DecoratableStream<X, M>, StreamAppenders<X, M>, StreamCollectors<X, M>, StreamConsumers<X, M>, StreamFilters<X, M>, StreamOptFilters<X, M>, StreamPrimitives<X, M> {

...
import lt.lb.commons.jobs.VoidJob;
...
//        });
    ...
    public void incrementTest() throws InterruptedException {
        doIncrement(10, jobs -> Dependencies.mutuallyExclusive(jobs));
        doIncrement(10, jobs -> Dependencies.backwardChain(jobs, SystemJobEventName.ON_SUCCESSFUL));
        doIncrement(10, jobs -> Dependencies.forwardChain(jobs, SystemJobEventName.ON_SUCCESSFUL));
    }
}

 ...
 * @author laim0nas100
 */
public interface TupleProjection4<R, T0, T1, T2, T3> extends TupleProjection3<R, T0, T1, T2> {

    public <C> Selection<T3> get3_path(Phase3Abstract<R, ?, C> from);

    public default T3 get3() {
        return null;
    }
